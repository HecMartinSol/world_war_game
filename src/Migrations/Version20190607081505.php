 ...
 */
final class Version20190607081505 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE war_history (id INT AUTO_INCREMENT NOT NULL, war_id INT NOT NULL, country_attacker_id INT NOT NULL, country_defender_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
